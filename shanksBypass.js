...
function startCountdown(onDone){
  ...
  var iv=setInterval(function(){
    s--;
    numEl.textContent=s;
    arc.setAttribute('stroke-dashoffset',(total/27)*(27-s));
    if(s<=0){
      clearInterval(iv);
      numEl.textContent='\u26a1';
